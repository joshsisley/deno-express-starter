...
import { validate } from "npm:express-validation";
import * as controller from '../../controllers/auth.controller.ts';
import * as oAuthMiddleware from '../../middlewares/auth.ts';
import {
  AuthValidation
...
router.route('/facebook')
  .post(validate(AuthValidation.oAuth), oAuthMiddleware.oAuth('facebook'), controller.oAuth);
 ...
 */
router.route('/google')
  .post(validate(AuthValidation.oAuth), oAuthMiddleware.oAuth('google'), controller.oAuth);
